...
function pay(amount) {
  ...
  if (remainingBalance > 0) {
    console.log("Insufficient payment. Please pay the remaining balance: " + remainingBalance);
    return -remainingBalance;
  } else {
    console.log("Payment successful. Change: " + -remainingBalance);
    emptyCart(); // Empty the cart after successful payment
    totalPaid = 0; // Reset the total paid amount after a successful payment
    return -remainingBalance;
  }
}
